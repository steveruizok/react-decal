 ...
 */
export function createAkimaSplineInterpolator(
 ...
 */
export function computeAkimaPolyCoefficients(
  xVals: ArrayLike<number>,
  yVals: ArrayLike<number>
): Float64Array[] {
  ...
  firstDerivatives[n - 1] = differentiateThreePoint(
    xVals,
    yVals,
    n - 1,
    n - 2,
  ...
  firstDerivatives[n] = differentiateThreePoint(
    xVals,
    yVals,
    n,
    n - 2,
 ...
 *    Polynomial coefficients of the segments.
 */
function computeHermitePolyCoefficients(
  xVals: ArrayLike<number>,
  yVals: ArrayLike<number>,
  firstDerivatives: ArrayLike<number>
): Float64Array[] {
